...
def main():
        ...
        response = """The meaning of life is a profound and philosophical question that has been contemplated by thinkers, theologians, and individuals throughout history. Answers vary widely depending on cultural, religious, and personal beliefs." +
...
Ultimately, the meaning of life may be subjective and can differ dramatically from one person to another. It often involves a combination of personal values, experiences, and beliefs."""#_gpt.ask_msg()
